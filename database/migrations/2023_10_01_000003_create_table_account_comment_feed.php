...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('account_comment_feed', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('account_comment_feed', function (Blueprint $table) {
            $table->dropConstrainedForeignId('id_account');
            $table->dropConstrainedForeignId('id_feed');
        });
        Schema::dropIfExists('account_comment_feed');
    }
};